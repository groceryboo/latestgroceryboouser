...
import 'package:groceryboouser/Screens/PaymentFlow/Wallet/view/TransactionHistory.dart';
...
class _WalletDashboardState extends State<WalletDashboard> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(children: [
                        Row(
                          children: [
                            setRegulerText(controller.fullNameText.value != "" 
                            ? controller.fullNameText.value : 'JASON STEM', 16.0, Colors.white,
                        ...
                        Align(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  setRegulerText("\$${controller.walletAmount.value}", 32.0, Colors.white,
                                      FontWeight.w700, FontStyle.normal),
                                ]))
                      ]),
                    ),
            ...
            Expanded(
                child: ListView.builder(
                    padding: EdgeInsets.fromLTRB(
                        ...
                        SizeConfig.screenWidth * 0.05,
                        SizeConfig.screenHeight * 0.025),
                    itemCount: controller.transactionList.length >= 3 ? 3 : controller.transactionList.length,
  ...
  Widget _listviewItem(context, index) {
    return    
    WalletTransactionItemWidget(transactionModel: controller.transactionList[index],);
