...
class TrxnDetailTopupDone extends StatefulWidget {
  const TrxnDetailTopupDone({Key key}) : super(key: key);

  @override
  _TrxnDetailTopupDoneState createState() => _TrxnDetailTopupDoneState();
}

class _TrxnDetailTopupDoneState extends State<TrxnDetailTopupDone> {
  @override
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.only(top: 2,bottom: 5,left: 14,right: 14),
                      decoration: BoxDecoration(
                          color: Colors.white,
