...
TokenUpdateModel tokenUpdateModelFromJson(String str) => TokenUpdateModel.fromJson(json.decode(str));

String tokenUpdateModelToJson(TokenUpdateModel data) => json.encode(data.toJson());
...
class TokenUpdateModel {
  ...
  factory TokenUpdateModel.fromJson(Map<String, dynamic> json) => TokenUpdateModel(
