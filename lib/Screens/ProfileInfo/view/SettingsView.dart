...
import 'package:groceryboouser/Screens/ProfileInfo/controller/SettingsController.dart';
                    ...
                    children: ListTile.divideTiles( //          <-- ListTile.divideTiles
                        ...
                        tiles: [
                          ListTile(
                            ...
                            subtitle:  Text(controller.phoneText.value.text,
                              style: TextStyle(
                                  color: black_273433,
                                  fontSize: 14,
                          ...
                          ListTile(
                            ...
                            subtitle: Text(controller.emailText.value.text,
                              style: TextStyle(
                                  color: black_273433,
                                  fontSize: 14,
                                  fontWeight: FontWeight.w600
                  ...
                  child: ListView(
                    ...
                    children: ListTile.divideTiles( //          <-- ListTile.divideTiles
                        ...
                        tiles: [
                          ...
                          SwitchListTile(value: controller.boolPushNotification.value, onChanged: (value){
                            setState(() {
                              controller.boolPushNotification.value = value;
                              controller.editUserProfileAPI(context);
                            });
                          },
                          ...
                          SwitchListTile(value: controller.boolLocationServices.value, onChanged: (value){
                            setState(() {
                              controller.boolLocationServices.value = value;
                              controller.locationServicesAction();
                            });
                          },
