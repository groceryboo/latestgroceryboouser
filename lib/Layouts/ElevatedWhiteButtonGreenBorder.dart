...
class ElevatedWhiteButtonGreenBorder extends StatelessWidget {
  ...
  ElevatedWhiteButtonGreenBorder(this.inputText,this.textColor,this.buttonColor, this.onCustomButtonPressed);
